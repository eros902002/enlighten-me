package com.erostech.enlightenme.ui.views;
...
import com.erostech.enlightenme.adapters.SearchAdapter;
import com.erostech.enlightenme.util.AnimationUtil;
...
public class CustomSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    private void initStyle(AttributeSet attrs, int defStyleAttr) {
        ...
        if (a != null) {
            ...
            if (a.hasValue(R.styleable.CustomSearchView_searchVoiceIcon)) {
                setVoiceIcon(a.getDrawable(R.styleable.CustomSearchView_searchVoiceIcon));
            }
            ...
            if (a.hasValue(R.styleable.CustomSearchView_android_inputType)) {
                setInputType(a.getInt(R.styleable.CustomSearchView_android_inputType, EditorInfo.TYPE_NULL));
            }
